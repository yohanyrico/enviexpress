...
class StoreTarifaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_ubicacion_origen'  => 'required|integer|exists:ubicacion,id_ubicacion',
            'id_ubicacion_destino' => 'required|integer|exists:ubicacion,id_ubicacion',
            'tipo_servicio'        => 'required|string|max:100',
            'peso_minimo_kg'       => 'required|numeric|min:0',
            'peso_maximo_kg'       => 'required|numeric|gte:peso_minimo_kg',
