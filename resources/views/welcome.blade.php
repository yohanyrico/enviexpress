                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Envios Express en Bogotá</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                    Servicio rápido y confiable de mensajería y paquetería con seguimiento en tiempo real y garantía de entrega                                            </p>
                                        </div>
                                    </div>
                            ...
                            <a
                                href="{{ route('login') }}"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-gray/[0.05] transition duration-300 text-black focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10"
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        ...
                                        <!-- Círculo de la lupa (borde verde, centro negro) -->
                                        <circle cx="11" cy="11" r="7" stroke="#3eff20" fill="#000000"/>
                                        <!-- Mango de la lupa (verde) -->
                                        <line x1="16.65" y1="16.65" x2="22" y2="22" stroke="#3eff20"/>
                                        </svg>
                                    </div>
                    ...
                    <footer class="py-16 text-center text-sm text-white">
                       © Enviexpress 2025 || Made with ❤️ in Bogotá
                    </footer>
                </div>
            </div>
        </div>
